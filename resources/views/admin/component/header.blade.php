                ...
                <div class="profile-dropdown position-relative" data-simplebar>
                  ...
                  <div class="d-flex align-items-center py-9 mx-7 border-bottom">
                    <div class="d-grid gap-2">
                      <img src="../../dists/images/profile/user-1.jpg" class="rounded-circle" width="80" height="80" alt="" />
                      
                      <a href="{{route('logout')}}" class="btn btn-sm mt-3 btn-outline-primary fs-2 ">Logout <i class="ti fs-2 ti-logout mx-2item-center"></i></a>
  
                    </div>
                    <div class="ms-3">
                      <i class="ti ti-user-circle fs-4"></i>
                      <b>Admin</b>
                      <h5 class="mb-1 fs-3"><i class="ti ti-user fs-4"></i> {{Auth::user()->name}}</h5>
                  ...
                  <div class="d-grid py-4 px-7 pt-8 ">
                    <div class="upgrade-plan bg-light-primary item-center position-relative overflow-hidden rounded-4 p-4 mb-9">
                      <div class="row">
                        <div class="col-6">
                          <h5 class="fs-4 mb-3 w-50 fw-semibold text-dark"> </h5>
                        </div>
